...
definterface Usecase.Test.Interface.ApplyStockin, Usecase.Interface.ApplyStockin do
  interface(:ac_signin, signin)
  interface(:ac_getdone, getdone)
  interface(:ac_create, create)
end

definterface Usecase.Test.Interface.ApproveStockin, Usecase.Interface.ApproveStockin do
  interface(:rc_signin, signin)
  interface(:rc_get_to_do, get_to_do)
end

definterface Usecase.Test.Interface.RejectStockin, Usecase.Interface.RejectStockin do
...
defactor Usecase.Test.Actor.CompanyOperator do
  import Usecase.Test.Interface.{ApplyStockin, ApproveStockin, RejectStockin}
...
###############    defmodule for test alone  fakest module    ################################
...
defmodule Yzd.Dsl.UsecaseTest do
  ...
  test "definterface - run -one item" do
    definterface Test.Single.A.B, A.B do
      interface(:userA1, getlist)
    end

    assert Test.Single.A.B.userA1() == %{biz: A.B, func: :getlist}
  end
